...
public class RulesEngineTest
{
    ...
    public async Task RulesEngine_InjectedRules_ContainsInjectedRules(string ruleFileName)
    {
        ...
        var input3 = GetInput3();

        List<RuleResultTree> result =
            await re.ExecuteAllRulesAsync("inputWorkflowReference", input1, input2, input3);
    ...
    public async Task ExecuteRule_AddWorkflowWithSameName_ThrowsValidationException(string previousWorkflowFile,
        string newWorkflowFile)
    {
    ...
    [Theory]
    [InlineData("rules1.json", "rules6.json")]
    public async Task ExecuteRule_AddOrUpdateWorkflow_ExecutesUpdatedRules(string previousWorkflowFile,
        string newWorkflowFile)
    {
        var re = GetRulesEngine(previousWorkflowFile);
    ...
    public async Task ExecuteRule_ManyInputs_ReturnsListOfRuleResultTree(string ruleFileName)
    {
        ...
        var input4 = GetInput1();
        var input5 = GetInput2();
        var input6 = GetInput3();

        var input7 = GetInput1();
        var input8 = GetInput2();
        var input9 = GetInput3();

        var input10 = GetInput1();
        var input11 = GetInput2();
        var input12 = GetInput3();

        var input13 = GetInput1();
        var input14 = GetInput2();
        var input15 = GetInput3();


        var input16 = GetInput1();
        var input17 = GetInput2();
        var input18 = GetInput3();
    ...
    public async Task ExecuteRule_ExceptionScenario_RulesInvalid(string ruleFileName)
    {
        ...
        List<RuleResultTree> result = await re.ExecuteAllRulesAsync("inputWorkflow", input1, input2, input3);
        Assert.NotNull(result);
        Assert.False(string.IsNullOrEmpty(result[0].ExceptionMessage) ||
                     string.IsNullOrWhiteSpace(result[0].ExceptionMessage));
    }
    ...
    public async Task ExecuteRule_InvalidWorkFlow_ThrowsException(string ruleFileName)
    {
        ...
        await Assert.ThrowsAsync<ArgumentException>(async () => {
            await re.ExecuteAllRulesAsync("inputWorkflow1", input);
        });
    }
    ...
    public async Task RemoveWorkflow_RemovesWorkflow(string ruleFileName)
    {
        ...
        await Assert.ThrowsAsync<ArgumentException>(async () =>
            await re.ExecuteAllRulesAsync("inputWorkflow", input1, input2, input3));
    }
        ...
        bool fastExpressionEnabled)
    {
        ...
        var bre = new RulesEngine(JsonConvert.DeserializeObject<Workflow[]>(fileData),
            new ReSettings { UseFastExpressionCompiler = fastExpressionEnabled });
        var result = await bre.ExecuteAllRulesAsync("inputWorkflow", ruleParams.ToArray());
        var ruleResult = result?.Find(r =>
            string.Equals(r.Rule.RuleName, "GiveDiscount10", StringComparison.OrdinalIgnoreCase));
    ...
    public async Task ExecuteRule_ReturnsProperErrorOnMissingRuleParameter(string ruleFileName)
    {
        ...
        Assert.NotNull(result);
        Assert.IsType<List<RuleResultTree>>(result);
        Assert.Contains(result[0].ChildResults,
            c => c.ExceptionMessage.Contains("Unknown identifier 'input1'"));
    }

    [Theory]
    [InlineData("rules5.json", "hello", true)]
    [InlineData("rules5.json", null, false)]
    public async Task ExecuteRule_WithInjectedUtils_ReturnsListOfRuleResultTree(string ruleFileName,
        string propValue, bool expectedResult)
    {
        var re = GetRulesEngine(ruleFileName);
    ...
    public async Task ExecuteRule_RuleWithMethodExpression_ReturnsSuccess(string ruleFileName)
    {
        var func = () => true;

        var re = GetRulesEngine(ruleFileName, new ReSettings { CustomTypes = new[] { typeof(Func<bool>) } });
    ...
    public async Task ExecuteRule_RuleWithUnaryExpression_ReturnsSuccess(string ruleFileName)
    {
        var re = GetRulesEngine(ruleFileName);
    ...
    public async Task ExecuteRule_RuleWithMemberAccessExpression_ReturnsSuccess(string ruleFileName)
    {
        var re = GetRulesEngine(ruleFileName);
    ...
    public async Task ExecuteRule_MissingMethodInExpression_ReturnsException(string ruleFileName)
    {
        ...
        await Assert.ThrowsAsync<RuleException>(async () => {
            _ = await re.ExecuteAllRulesAsync("inputWorkflow", new RuleParameter("input1", input1));
        });
    }
    ...
    [Theory]
    [InlineData("rules9.json")]
    public async Task ExecuteRuleWithIgnoreException_CompilationException_DoesNotReturnsAsErrorMessage(
        string ruleFileName)
    {
        var re = GetRulesEngine(ruleFileName,
            new ReSettings { EnableExceptionAsErrorMessage = true, IgnoreException = true });
    ...
    {
        var re = GetRulesEngine(ruleFileName,
            new ReSettings { EnableExceptionAsErrorMessage = true, CustomTypes = new[] { typeof(JsonElement) } });

        var input1 = new { Data = JsonSerializer.SerializeToElement(new { category = "abc" }) };
    ...
    public async Task RulesEngineWithGlobalParam_RunsSuccessfully(string ruleFileName)
    {
        ...
        var input1 = new[] {
            new { Value = 0.13259286, ChangeDateTime = "2023-07-28T19:57:07.432339Z" },
            new { Value = 0.09435427, ChangeDateTime = "2023-07-28T19:58:04.536459Z" },
            new { Value = 0.14896593, ChangeDateTime = "2023-07-28T19:59:08.682072Z" },
            new { Value = 0.12852388, ChangeDateTime = "2023-07-28T20:00:06.78036Z" },
            new { Value = 0.17011189, ChangeDateTime = "2023-07-28T20:00:54.873615Z" },
            new { Value = 0.0532116, ChangeDateTime = "2023-07-28T20:02:52.04049Z" },
            new { Value = 0.04064374, ChangeDateTime = "2023-07-28T20:03:54.168499Z" },
            new { Value = 0.03748944, ChangeDateTime = "2023-07-28T20:03:54.194786Z" },
            new { Value = 0.07752395, ChangeDateTime = "2023-07-28T20:06:32.451464Z" },
            new { Value = 0.07294922, ChangeDateTime = "2023-07-28T20:07:38.691755Z" },
            new { Value = 0.09892442, ChangeDateTime = "2023-07-28T20:08:37.98802Z" },
            new { Value = 0.06370641, ChangeDateTime = "2023-07-28T20:05:41.358461Z" },
            new { Value = 0.07550429, ChangeDateTime = "2023-07-28T20:09:48.129748Z" },
            new { Value = 0.0653021, ChangeDateTime = "2023-07-28T20:10:48.274482Z" },
            new { Value = 0.09304246, ChangeDateTime = "2023-07-28T20:11:49.436983Z" },
            new { Value = 0.0797422, ChangeDateTime = "2023-07-28T20:12:53.609118Z" },
            new { Value = 0.08211832, ChangeDateTime = "2023-07-28T20:13:52.699728Z" },
            new { Value = 0.06955433, ChangeDateTime = "2023-07-28T20:15:03.843289Z" },
            new { Value = 0.07626661, ChangeDateTime = "2023-07-28T20:15:03.870057Z" },
            new { Value = 0.05033984, ChangeDateTime = "2023-07-28T20:16:17.032262Z" },
            new { Value = 0.05202596, ChangeDateTime = "2023-07-28T20:17:20.172669Z" },
            new { Value = 0.06861198, ChangeDateTime = "2023-07-28T20:18:32.303309Z" },
            new { Value = 0.04935532, ChangeDateTime = "2023-07-28T20:19:33.451426Z" },
            new { Value = 0.04073699, ChangeDateTime = "2023-07-28T20:20:37.737395Z" },
            new { Value = 0.02164916, ChangeDateTime = "2023-07-28T20:21:38.883635Z" },
            new { Value = 0.01334031, ChangeDateTime = "2023-07-28T20:22:40.053193Z" },
            new { Value = 0.0336915, ChangeDateTime = "2023-07-28T20:23:44.240297Z" },
            new { Value = 0.04870055, ChangeDateTime = "2023-07-28T20:26:33.584756Z" },
            new { Value = 0.07125243, ChangeDateTime = "2023-07-28T20:28:11.7889Z" },
            new { Value = 0.04904275, ChangeDateTime = "2023-07-28T20:24:40.346216Z" },
            new { Value = 0.03625701, ChangeDateTime = "2023-07-28T20:27:20.707478Z" },
            new { Value = 0.05703328, ChangeDateTime = "2023-07-28T20:28:57.876436Z" },
            new { Value = 0.04364996, ChangeDateTime = "2023-07-28T20:25:43.496357Z" },
            new { Value = 0.07558272, ChangeDateTime = "2023-07-28T20:30:11.023295Z" },
            new { Value = 0.03073958, ChangeDateTime = "2023-07-28T20:33:00.347672Z" },
            new { Value = 0.0341309, ChangeDateTime = "2023-07-28T20:33:59.790621Z" },
            new { Value = 0.05270871, ChangeDateTime = "2023-07-28T20:31:15.166193Z" },
            new { Value = 0.09138862, ChangeDateTime = "2023-07-28T20:32:08.259273Z" },
            new { Value = 0.15922104, ChangeDateTime = "2023-07-28T20:35:12.963809Z" },
            new { Value = 0.11383641, ChangeDateTime = "2023-07-28T20:36:26.120815Z" },
            new { Value = 0.12404025, ChangeDateTime = "2023-07-28T20:37:37.27212Z" },
            new { Value = 0.06010197, ChangeDateTime = "2023-07-28T20:38:47.409412Z" },
            new { Value = 0.08396237, ChangeDateTime = "2023-07-28T20:39:37.504217Z" },
            new { Value = 0.06731881, ChangeDateTime = "2023-07-28T20:40:27.588895Z" },
            new { Value = 0.05617253, ChangeDateTime = "2023-07-28T20:41:33.760373Z" },
            new { Value = 0.0585155, ChangeDateTime = "2023-07-28T20:42:26.847144Z" },
            new { Value = 0.06793098, ChangeDateTime = "2023-07-28T20:43:36.988904Z" },
            new { Value = 0.06879344, ChangeDateTime = "2023-07-28T20:44:46.133926Z" },
            new { Value = 0.06931814, ChangeDateTime = "2023-07-28T20:45:50.275932Z" },
            new { Value = 0.04802603, ChangeDateTime = "2023-07-28T20:46:36.367289Z" },
            new { Value = 0.04036225, ChangeDateTime = "2023-07-28T20:47:27.484188Z" },
            new { Value = 0.04968483, ChangeDateTime = "2023-07-28T20:48:13.582228Z" },
            new { Value = 0.0773483, ChangeDateTime = "2023-07-28T19:49:16.354277Z" },
            new { Value = 0.08710921, ChangeDateTime = "2023-07-28T19:48:25.253743Z" },
            new { Value = 0.07665287, ChangeDateTime = "2023-07-28T19:50:25.496642Z" },
            new { Value = 0.06121748, ChangeDateTime = "2023-07-28T19:51:20.644955Z" },
            new { Value = 0.04179136, ChangeDateTime = "2023-07-28T19:52:26.793369Z" },
            new { Value = 0.13522345, ChangeDateTime = "2023-07-28T19:54:19.051669Z" },
            new { Value = 0.08536856, ChangeDateTime = "2023-07-28T19:56:04.287806Z" },
            new { Value = 0.05041369, ChangeDateTime = "2023-07-28T19:53:18.901696Z" },
            new { Value = 0.1627249, ChangeDateTime = "2023-07-28T19:55:13.160235Z" },
            new { Value = 0.05, ChangeDateTime = "2023-07-28T19:54:03.2197Z" },
            new { Value = 0.05, ChangeDateTime = "2023-07-28T19:56:00.802023Z" },
            new { Value = 0.02792705297470093, ChangeDateTime = "2023-07-28T20:49:03.6825337Z" }
        }.ToList();
    ...
    public async Task ExecuteRule_WithStringMethod_ReturnsListOfRuleResultTree(string ruleFileName)
    {
        var re = GetRulesEngine(ruleFileName);
    ...
    [Fact]
    public async Task ExecuteRule_WithStaticMethod_ReturnsListOfRuleResultTree()
    {
        var workflow = new Workflow {
            ...
            Rules = new[] {
                new Rule {
                    ...
                    Expression = "!TestInstanceUtils.CheckExistsStatic(input1.country)",
    ...
    public async Task ExecuteRule_RuntimeError_ShouldReturnAsErrorMessage()
    {
        var workflow = new Workflow {
            ...
            Rules = new[] {
                new Rule { RuleName = "ruleWithRuntimeError", Expression = "input1.Country.ToLower() == \"india\"" }
            }
        };
    ...
    public async Task ExecuteRule_RuntimeError_ThrowsException()
    {
        ...
        _ = await Assert.ThrowsAsync<RuleException>(
            async () => await re.ExecuteAllRulesAsync("TestWorkflow", input));
    }
        ...
        var workflow = new Workflow {
            ...
            Rules = new Rule[] {
                new() {
                    ...
                    LocalParams = new List<LocalParam> { new() { Name = "lp1", Expression = "true" } },
                    RuleExpressionType = RuleExpressionType.LambdaExpression,
                    Expression = "lp1 ==  true"
                }
            }
    ...
    public async Task ClearWorkFlow_ShouldRemoveAllCompiledCache()
    {
        var workflow = new Workflow {
            ...
            Rules = new Rule[] {
                new() {
                    RuleName = "RuleWithLocalParam",
                    LocalParams = new LocalParam[] { new() { Name = "lp1", Expression = "true" } },
                    RuleExpressionType = RuleExpressionType.LambdaExpression,
                    Expression = "lp1 ==  true"
                }
            }
    ...
    public async Task ExecuteRule_WithNullInput_ShouldNotThrowException()
    {
        ...
        Assert.True(result3.TrueForAll(c => c.IsSuccess));
    }
    ...
    public async Task ExecuteRule_SpecialCharInWorkflowName_RunsSuccessfully()
    {
        ...
        var re = new RulesEngine([workflowStr]);
    ...
    public void ContainsWorkFlowName_ShouldReturn()
    {
        ...
        var workflow = new Workflow {
            ...
            Rules = new Rule[] {
                new() {
                    RuleName = "Rule", RuleExpressionType = RuleExpressionType.LambdaExpression, Expression = "1==1"
                }
            }
        };
    ...
    private RulesEngine GetRulesEngine(string filename, ReSettings reSettings = null)
    {
        ...
        var injectWorkflow = new Workflow {
            WorkflowName = "inputWorkflowReference", WorkflowsToInject = new List<string> { "inputWorkflow" }
        };
    ...
    {
        var content = GetFileContent(workflowsFileName);
    ...
    {
        var basicInfo =
            "{\"name\": \"Dishant\",\"email\": \"abc@xyz.com\",\"creditHistory\": \"good\",\"country\": \"canada\",\"loyaltyFactor\": 3,\"totalPurchasesToDate\": 70000}";
        var orderInfo = "{\"totalOrders\": 50,\"recurringItems\": 2}";
        var telemetryInfo = "{\"noOfVisitsPerMonth\": 10,\"percentageOfBuyingToVisit\": 15}";
        var laborCategoriesInput =
            "[{\"country\": \"india\", \"loyaltyFactor\": 2, \"totalPurchasesToDate\": 20000}]";
    ...
    public class TestInstanceUtils
    {
        ...
        /// <summary>
        ///     Just to check if static methods are imported
        /// </summary>
        /// <param name="str"></param>
        /// <returns></returns>
        public static bool CheckExistsStatic(string str)
        {
